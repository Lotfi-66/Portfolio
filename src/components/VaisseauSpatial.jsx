        ...
        mtlLoader.load(
            ...
            (materials) => {
                ...
                objLoader.load(
                    ...
                    (error) => console.error('Erreur lors du chargement du modèle OBJ', error)
                );
            },
            (xhr) => console.log(`${(xhr.loaded / xhr.total * 100).toFixed(0)}% MTL chargé`),
            (error) => console.error('Erreur lors du chargement du fichier MTL', error)
        );
